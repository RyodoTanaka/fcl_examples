...
int main(int argc, char* argv[]) {
    ...
    // Sphere
    std::shared_ptr<fcl::CollisionGeometry<double>> sphere_geometry(new fcl::Sphere<double>(1.0));
    ...
    // Calculate distance
    result.clear();
    double dist = fcl::distance(&cylinder, &sphere, request, result);
